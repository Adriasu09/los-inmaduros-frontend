    ...
    >
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-6 py-12 text-center">
        ...
        <div className="mt-10 flex w-full max-w-sm flex-col sm:flex-row gap-4">
          <Link
            href="/routes"
            className="flex-1 flex items-center justify-center h-13 rounded-full bg-sky-400 text-white text-base font-bold hover:bg-sky-500 active:scale-95 transition-all"
          >
            Ver rutas
          </Link>
          <Link
            href="/"
            className="flex-1 flex items-center justify-center h-13 rounded-full bg-slate-800 text-slate-100 text-base font-bold hover:bg-slate-700 active:scale-95 transition-all"
          >
            Ir al inicio
          </Link>
        </div>
          ...
          <div className="flex justify-center gap-6">
            {SOCIAL_LINKS.map(({ href, label, icon: Icon }) => (
              ...
              >
                ...
                <span className="text-xs font-bold uppercase tracking-wide text-slate-400 group-hover:text-slate-100 transition-colors">
                  {label}
                </span>
              </a>
            ))}
